...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TaskList', fields ['title']
        db.delete_unique(u'todo_tasklist', ['title'])

        # Adding field 'Event.creator'
        db.add_column(u'todo_event', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Event.created_date'
        db.alter_column(u'todo_event', 'created_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Adding unique constraint on 'TaskList', fields ['title']
        db.create_unique(u'todo_tasklist', ['title'])

        # Deleting field 'Event.creator'
        db.delete_column(u'todo_event', 'creator_id')


        # Changing field 'Event.created_date'
        db.alter_column(u'todo_event', 'created_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'todo.event': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
